...
class TweetTestCase(TestCase):
    def setUp(self):
        # I was using User.objects.create() insted of User.objects.create_user() was very big trouble
        self.user = User.objects.create_user(username='jsupa', password='somepassword')
        self.userb = User.objects.create_user(username='jsupa2', password='somepassword2')
